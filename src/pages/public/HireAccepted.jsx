...
// server-side in api/meeting-outcome.js, this page just fires that request
// and shows the celebration.
  ...
  return (
    <div style={{ minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#fff', padding: '48px 24px' }}>
      ...
      <div style={{ maxWidth: 480, textAlign: 'center' }}>
        <img src="/Client_to_creative.png" alt="" style={{ width: '100%', maxWidth: 280, margin: '0 auto', display: 'block' }} />
        <h1 style={{ marginTop: 32, fontSize: 'clamp(28px, 4vw, 38px)' }}>You did it.</h1>
        ...
        <div style={{ marginTop: 40, padding: 24, background: 'var(--color-bg-soft)', borderRadius: 12 }}>
          <img src="/Collaborate2.png" alt="" style={{ width: '100%', maxWidth: 160, margin: '0 auto 16px', display: 'block' }} />
